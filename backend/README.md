...
## Project Structure
    ...
    ├── testapiautocatalog_113296  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_113296`
...
2. Clone this repo and `cd testapiautocatalog_113296`
